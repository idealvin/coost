...
- `socket`, `tcp_socket`, `udp_socket` are used to create sockets. The created sockets are non-blocking on Linux/Mac, and [overlapped](https://support.microsoft.com/en-us/help/181611/socket-overlapped-io-versus-blocking-nonblocking-mode) on Windows.
