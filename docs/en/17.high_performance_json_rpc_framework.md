...
- rpc_max_json_parse_buffer_size

  Specify max size of the buffer for `json::parse`. The default is 4k. The buffer must be big enough to save all keys of a json object. See details in [json 16.5](16.efficient_json_library.md/16.5-String-to-json).
