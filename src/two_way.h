...
/* Perform a critical factorization of NEEDLE, of length NEEDLE_LEN.
   ...
   *PERIOD to the global period of the right half.
   ...
   periodicity.  */
static size_t
FN_NAME(critical_factorization)(const unsigned char *needle, size_t needle_len, 
                                size_t *period)
{
...
static RETURN_TYPE
FN_NAME(two_way_short_needle) (const unsigned char *haystack, size_t haystack_len,
...
static RETURN_TYPE
FN_NAME(two_way_long_needle) (const unsigned char *haystack, size_t haystack_len,
		                      const unsigned char *needle, size_t needle_len)
{
  size_t i; /* Index into current byte of NEEDLE.  */
  size_t j; /* Index into current window of HAYSTACK.  */
