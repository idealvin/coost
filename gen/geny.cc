...
static const YYINT yystos[] = {                           0,
  274,  286,  262,  287,  288,  289,  257,  263,  272,  279,
  290,  291,  257,  257,  123,  123,  276,  281,  257,  125,
  275,  257,  264,  265,  266,  267,  268,  269,  270,  271,
  272,  123,  125,   91,  277,  278,  280,  282,  283,   44,
   59,  292,  123,  281,  257,  278,  257,  282,  123,   91,
  281,  125,   93,   61,  284,  281,  278,  125,  258,  259,
  260,  261,  285,  125,   93,
};
...
"tok_object","$accept","Program","Method","MethodList","BaseType","FieldType",
"Object","AnonymousObject","FieldList","FieldName","Field","FieldValue",
"ConstValue","HeaderList","DefinitionList","Header","Package","Definition",
"Service","Separ","illegal-symbol",
};
